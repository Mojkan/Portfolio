...
The block can be moved anywhere in the room but it will always be align with rooms walls preventing awkward rotations that might frustrate the player, even when it gets pushed down a ledge.
